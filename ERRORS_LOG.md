# Journal des erreurs — projet Rouage
...
|---|---|---|
| Validation HTML | html-validate, 6 pages | 0 erreur |
| Accessibilité | axe-core WCAG 2.1 AA, 6 pages × 2 tailles | 0 violation |
| Console navigateur | Playwright, 6 pages × 3 tailles | 0 erreur, 0 requête en échec |
| Débordement horizontal | 375 / 768 / 1440 px | aucun |
| Structure Hn | 6 pages | un seul H1 par page |
| Liens internes | 8 cibles distinctes | aucun lien cassé |
| Sans JavaScript | page d'accueil et formulaire | contenu intégral affiché, formulaire fonctionnel |
| Lighthouse desktop | 4 pages | 100 / 100 / 100 / 100 |
| Lighthouse mobile | 3 pages | 100 / 100 / 100 / 100 — LCP 1,5–1,7 s, CLS 0, TBT 0 ms |
